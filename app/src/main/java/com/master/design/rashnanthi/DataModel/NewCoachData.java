...
public class NewCoachData {
    ...
    private ArrayList<NewCoachImagData> imagedata;
    ...
    public ArrayList<NewCoachImagData> getImagedata ()
    {
        return imagedata;
    }

    public void setImagedata (ArrayList<NewCoachImagData> imagedata)
    {

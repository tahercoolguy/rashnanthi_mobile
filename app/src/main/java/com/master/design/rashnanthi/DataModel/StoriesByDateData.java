...
public class StoriesByDateData {
    ...
    private ArrayList<StoriesByImageData> imagedata;
    ...
    public ArrayList<StoriesByImageData> getImagedata() {

        return imagedata;

    }

    public void setImagedata(ArrayList<StoriesByImageData> imagedata) {

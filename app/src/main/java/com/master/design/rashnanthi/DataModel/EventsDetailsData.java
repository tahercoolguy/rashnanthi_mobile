...
public class EventsDetailsData {
    ...
    private ArrayList<EventsDetailsImageData> imagedata;
    ...
    public ArrayList<EventsDetailsImageData> getImagedata() {

        return imagedata;

    }

    public void setImagedata(ArrayList<EventsDetailsImageData> imagedata) {
